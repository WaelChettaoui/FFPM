...
*Open the project:*<br>
Run Code::Blocks, and open the project in `FFPM/build/codeblocks`.<br>
Finally, build and run the project.
...
cmake ../FFPM -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-FFPM`.<br>
